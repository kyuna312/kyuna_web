...
export const projectLineup = [
  ...
  },
  {
    key: 'skinmarket',
    group: 'products',
    thumbnail: '/images/works/skinmarket.png',
    url: 'https://skinmarket.app.mn',
    tech: 'Next.js · React · TypeScript · Steam API · Cloudflare'
  },
  {
    key: 'mcosmetics',
    group: 'products',
    thumbnail: '/images/works/mcosmetics.png',
    url: 'https://mcosmetics.mn',
    tech: 'React · Vite · E-commerce'
  },
  {
    key: 'mongolnet',
    group: 'products',
...
// Section order on the projects page. Database rows carry no group, so the
// page looks it up here by key; unknown keys land in 'products'.
export const projectGroups = ['tooling', 'experiment', 'products']
export const groupOf = key =>
  projectLineup.find(p => p.key === key)?.group || 'products'
