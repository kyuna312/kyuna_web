	...
	<Layout title="Projects">
		<Container paddingTop={20}>
			...
			<SimpleGrid columns={[ 1, 1, 2 ]} gap={6}>
				<Section>
					<ProjectGridItem id="NomadX" title="NomadX" thumbnail={nomadx}>
						Mongolian NFT Market Place Web Application and Mobile Application
					</ProjectGridItem>
				</Section>
				<Section>
					<ProjectGridItem id="mongolnet" title="mongolnet" thumbnail={mongolnet}>
				...
				<Section>
					<ProjectGridItem id="NyanMarkDown " title="NyanMarkDown " thumbnail={mongolnet}>
						NyanMarkDown Custom Mark Down Editor{' '}
					</ProjectGridItem>
				</Section>
				<Section>
					<ProjectGridItem id="madoka_react " title="madoka_react " thumbnail={mongolnet}>
						My Custom React JS Vite Based SASS animated web
					</ProjectGridItem>
				</Section>
				<Section delay={0.1}>
					<ProjectGridItem id="nyanvim" title="nyanvim" thumbnail={mongolnet}>
						my custom vim code
					</ProjectGridItem>
				</Section>
			</SimpleGrid>
