    ...
    <Container paddingTop={20}>
      ...
      <Section delay={0.1}>
        ...
        <Box marginLeft={4} marginTop={4}>
          <p>
            ハタンゾリグはウランバートルを拠点とするフルスタック開発者で、プロダクトの計画、デザイン、コーディングを通じた問題解決に情熱を持ち、5年間のモバイルおよびウェブ開発経験を有しています。大学3年から取り組んできた技術を活かし、様々なプロジェクトで専門知識を提供しています。

            リバースエンジニアリングやエクスプロイト開発への関心も強く、自作のオペレーティングシステムの構築にも挑戦中です。オフラインでは、アニメやマンガ、ライトノベルを楽しみ、時にはコスプレも趣味としています。現在、Odoo ERPの業務プロジェクトに従事しつつ、シンプルなカーネルOSなどの独自プロジェクトも進行中です。{' '}
          </p>
        </Box>
